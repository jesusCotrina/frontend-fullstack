                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Haz clic en el botón &apos;Crear lista&apos; y asigna un
                      nombre a tu nueva lista de tareas.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Escribe las tareas que deseas incluir en tu lista y
                      presiona Enter para añadirlas.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      Marca las tareas completadas, elimina las que ya no son
                      necesarias y organiza tu lista a tu gusto.
                    </span>
                  </Fragment>
                )}
              </span>
